      ...
      <AnimatePresence>
        {!isOpen && (
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            onClick={togglePanel}
            className="fixed bottom-[calc(5.5rem+env(safe-area-inset-bottom))] md:bottom-6 right-6 z-50 w-14 h-14 rounded-full bg-gradient-to-br from-violet-500 to-blue-600 text-white shadow-2xl shadow-violet-500/25 flex items-center justify-center hover:shadow-violet-500/40 transition-shadow"
